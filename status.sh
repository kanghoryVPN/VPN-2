...
echo -e "           OWNER : ${GREEN} KANG HORY ${NC}${YELLOW}(${NC} ${GREEN} SC BY KANG HORY VPN  ${NC}${YELLOW})${NC}"
echo -e "       © Copyright By KANG HORY TUNNEL ${YELLOW}(${NC} 2023-LIFETIME ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
