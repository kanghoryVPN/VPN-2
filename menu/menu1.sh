...
echo -e "                 ${BICyan}${On_IPurple}SCRIPT MULTI By ${UWhite}KANG HORY VPN${NC}"
echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
...
9) clear ; genssl ;;
10) clear ; jam ;;
6969) clear ; wget https://raw.githubusercontent.com/kanghory/VPN-2/main/update.sh && chmod +x update.sh && ./update.sh && rm -f /root/update.sh ;;
0) clear ; menu ;;
x) exit ;;
